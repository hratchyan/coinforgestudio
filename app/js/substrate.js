...
(function () {
  ...
  function norm(doc) {
    ...
    /* non-circle or rubber docs are a v1.7 format — older clients would misread them */
    if ((doc.substrate.kind !== 'circle' || doc.material === 'rubber') && (doc.version || 0) < 3) doc.version = 3;
