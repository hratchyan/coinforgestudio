...
(function () {
  ...
  async function openManager() {
    ...
    async function refillCloud() {
      ...
      if (max === 0) {
        ...
        const tease = U.el('div', { class: 'cf-cloudtease' },
          ...
          U.el('div', { class: 'cf-cloudtease-txt' },
            ...
            ' Cloud slots sync your coins to any device you sign in on. Pro includes 10 slots — and the production toolkit as it ships.',
      ...
      /* free tier: gentle upsell for the other 9 slots + the toolkit */
      if (tier === 'free' && CF.billing) {
        const up = U.el('div', { class: 'cf-cloudtease', style: { marginTop: '10px' } },
          U.el('div', { class: 'cf-cloudtease-txt' },
            ...
            '. Pro unlocks ', U.el('b', null, '10 slots'), ' and the Pro production toolkit — ',
  ...
  function mountBanner() {
    ...
    const bar = U.el('div', { id: 'cf-storebanner' },
      U.el('span', { class: 'cf-storebanner-txt' },
        ...
        ' + unlimited local saves (this device). Pro unlocks 10 cloud slots and the production toolkit.'),
